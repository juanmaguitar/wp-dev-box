<?php
/**
 * Render output of property-cpt-md/details
...
<div <?php echo wp_kses( get_block_wrapper_attributes(), true ); ?>>
	<div>
		...
		<p><?php esc_html( get_post_meta( $post->ID, 'bedrooms', true ) ); ?> Bedrooms</p>
	</div>
	...
	<div>
		...
		<p><?php esc_html( get_post_meta( $post->ID, 'bathrooms', true ) ); ?> Bathrooms</p>
	</div>
	...
	<div>
		...
		<p>$<?php esc_html( get_post_meta( $post->ID, 'price', true ) ); ?></p>
	</div>
	...
	<div>
		...
		<p><?php esc_html( get_post_meta( $post->ID, 'squareFootage', true ) ); ?> SQ FT</p>
	</div>
</div>
